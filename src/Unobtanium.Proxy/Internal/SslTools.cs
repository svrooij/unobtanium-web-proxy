...
namespace Unobtanium.Proxy.Internal;
...
internal class SslTools
{
    ...
    /// <returns></returns>
    public static async Task<ClientHelloInfo?> PeekClientHello(Stream clientStream, ActivityContext? activityContext,
        CancellationToken cancellationToken = default)
    {
        ...
        var pipeReader = PipeReader.Create(clientStream);
